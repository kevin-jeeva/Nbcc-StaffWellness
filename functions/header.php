		  		...
		  		<ul class=\"navbar-nav mr-auto markings\">
					...
					<div class=\"notifications row\" >							
						...
						<li class=\"notify-container\" id =\"notify-container\">
							<span class=\"notify-bubble\" id =\"bubble-noti\">" . Content::setNotificationBubble($_SESSION["notifications"]) . "</span>
						</li>
						</li>					
					</div>
					</div>
					...
					content: function() {
						...
						return `".Content::bellNotifications($_SESSION["notifications"])." <a href=\"notifications.php\" class=\"btn btn-block btn-outline-ngreen\")\">View More</a>`;
					}
					};
