...
session_start();
 ...
 if(isset($_POST["resourceListId"]) && isset($_POST["contentTitle"]) && isset($_POST["content-area"]) && isset($_POST["content-description"]))
 {
    ...
    $content = new Content(0,0, $content_Title,$content_text,$content_description,0,0);
