		...
		<div class="container">
		  <div class="row">
		    ...
		    <div class="the-content col-md-8">
		    	<form method="post" id="newContentForm" name="newContentForm" onsubmit="return EditWelcomeCheck()" action="proc_editWelcome" enctype="multipart/form-data">
		    	  <div class="form-group col-xs-12 col-md-12">   	    
							<div class="form-group col-xs-6 col-md-4">
								<label for="content-title" id="content-title">Welcome Title</label>
								<input type="text" class="form-control" placeholder="Enter welcome title" name ="edit_welcomeTitle" id="edit_welcomeTitle" required>
							</div>
							<div class="form-group col-lg-12">
								<label for="content-description">Select a Welcome Image</label>
                <div></div>
							  <input class ="welcome_image_button" id="edit_welcome_image" name="pic" type="file" accept="image/*" onchange="editImageChange()"><br>
              </div>	
              <div class="form-group col-lg-12">
                <label for="content-description">Uploaded Image Name: </label>
                <label id="image_name"></label>
              </div>
             		<div class="form-group col-lg-12">
								<label for="content-description">Welcome Text</label>
								<textarea class="form-control" id="edit_welcome-description" name="edit_welcome-description" placeholder="Welcome Description" rows="5" maxlength="255" required></textarea>
							</div>							
							<br>
							<div class="form-group col-lg-12">
              ...
              <input type="hidden" id="edit_welcome_id" name="edit_welcome_id">
		    	</form> 	
		    </div>
