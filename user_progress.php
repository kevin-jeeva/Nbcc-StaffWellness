...
<head>
	...
	<link rel="stylesheet" type="text/css" href="includes/dataTables.bootstrap4.min.css">
</head>
...
<body>  
	...
	<div class="jumbotron jumbotron-fluid">
	  <div class="container">
	    <h1 class="display-4">Staff Progress</h1>
		    ...
		    <div class="the-content col-md-12">
		    	...
		    	<div class="list-sector">
			    	<div class="list-header row">
		    	  		<h2>Every Staff Progress</h2>		    	  	
			    	</div><BR>
            <div class="table-responsive">
			    	  	<table id="admTable" class="table sortable table-striped table-dark">
				    	      <!-- Table's Header -->
				    	     <?php Progress::ViewStaffProgress();?>
			    	    </table>
