		...
		<div class="container">
		  <div class="row">
		    ...
		    <div class="the-content col-md-8">
		    	<form method="post" id="newContentForm" name="newContentForm" onsubmit="return AudioCheck()" action="proc_new_audio.php"  enctype="multipart/form-data">
                ...
                <div></div>
							  <input id="sound_file" name="audio" type="file" accept="audio/*"><br>
							</div>	
             		<div class="form-group col-lg-12">
							...
							<br>
							<div class="form-group col-lg-12">
								<input type="submit" class="btn btn-ngreen" name ="submit"value="Submit"/>
