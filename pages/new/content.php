		...
		<div class="container">
		  <div class="row">
		    ...
		    <div class="the-content col-md-8">
		    	<form method="post" id="newContentForm" name="newContentForm" action="proc_newcategory">
		    	  <div class="form-group col-xs-6 col-md-4">
		    	    <label for="content-title">Content Title</label>
		    	    <input type="text" class="form-control" id="content-title" name="content-title" placeholder="Category Title" size="45" maxlength="45" required>
		    	  </div>
